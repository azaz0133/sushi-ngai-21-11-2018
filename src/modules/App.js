...
import feqQuestions from './policy/feqQuestions'
   ...
   <div style={sectionStyle}>
        ...
        <Header>
            <Switch>
             ...
             <Route exact path ='/policy/feqquestions' component={feqQuestions} />
             <Route exact path ='/policy/TermsOfUse' component={TermsOfUse} />
